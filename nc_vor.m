...
for ii=1:12%循环月份
    ...
    hold on
    contourf(lon1,lat1,vor*10^5)%,[-14:2:14],'LineColor','k','ShowText','on','TextList',[-14:2:14]);
    colormap(jet)
    ...
    hold on
    [cs1,h1]=contour(lon1,lat1,vor*10^5);%[-40:10:100]
    ...
    title([ '200hPa Vorticity/10^{-5}s^{-1}'],'FontName','Times New Roman','fontsize',10)
    hold on
    print( 1, '-dpng', '-r600',['C:\Users\lj\Desktop\div\pic\'  num2str(ii) '月_200hPa_vor.png'])
    saveas(1,['C:\Users\lj\Desktop\div\pic\' num2str(ii) '月_200hPa_vor.fig'])
    close(1)
end